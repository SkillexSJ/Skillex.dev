    ...
    >
      ...
      >
        ...
        >
          <button
            type="button"
            className="sm-logo flex items-center select-none pointer-events-auto bg-transparent border-0 p-0"
...
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; background: #171717; border-left: 1px solid rgba(255,255,255,0.05); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow-y: auto; z-index: 10; }
